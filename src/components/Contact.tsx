      ...
      <div className="space-y-6">
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-gray-300">123 Solar Avenue</p>
            <p className="text-gray-300">Greencity, GC 12345</p>
          </div>
        </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-gray-300">info@renewablepowersolutions.com</p>
          </div>
        </div>
      </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold/50 transition-all duration-300"
                      required
                    />
                  </div>
