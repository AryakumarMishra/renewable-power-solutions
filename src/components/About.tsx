      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-4 mt-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Our team consists of fully certified and experienced renewable energy specialists.</p>
                </div>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-6 w-6 text-gold mr-3 flex-shrink-0 mt-0.5" />
                <div>
                  ...
                  <p className="text-gray-600">We use only the highest quality, efficient, and durable components in all our installations.</p>
                </div>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-6 w-6 text-gold mr-3 flex-shrink-0 mt-0.5" />
                <div>
                  ...
                  <p className="text-gray-600">Every project is tailored to meet the specific needs and circumstances of our clients.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-on-scroll" style={{ transitionDelay: '200ms' }}>
            ...
            <div className="absolute -bottom-8 right-8 bg-white rounded-lg p-4 shadow-lg z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24">
          <div className="bg-gray-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 animate-on-scroll text-center">
            <div className="flex justify-center mb-4">
              <div className="p-3 bg-gold/10 rounded-full">
                <Award className="h-8 w-8 text-gold" />
              </div>
            </div>
            <h3 className="text-xl font-bold mb-3 font-playfair">Our Mission</h3>
            <p className="text-gray-600">To accelerate the transition to sustainable energy through innovative, high-quality solutions that benefit our customers and the planet.</p>
          </div>
          
          <div className="bg-gray-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 animate-on-scroll text-center" style={{ transitionDelay: '100ms' }}>
            <div className="flex justify-center mb-4">
              <div className="p-3 bg-gold/10 rounded-full">
                <Users className="h-8 w-8 text-gold" />
              </div>
            </div>
            <h3 className="text-xl font-bold mb-3 font-playfair">Our Team</h3>
            <p className="text-gray-600">A dedicated group of renewable energy experts committed to delivering exceptional service and sustainable solutions.</p>
          </div>
          
          <div className="bg-gray-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 animate-on-scroll text-center" style={{ transitionDelay: '200ms' }}>
            <div className="flex justify-center mb-4">
              <div className="p-3 bg-gold/10 rounded-full">
                <Award className="h-8 w-8 text-gold" />
              </div>
            </div>
            <h3 className="text-xl font-bold mb-3 font-playfair">Our Values</h3>
            <p className="text-gray-600">Integrity, innovation, excellence, and sustainability guide every aspect of our operations and customer interactions.</p>
          </div>
        </div>
      </div>
    </section>
